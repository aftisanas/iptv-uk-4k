      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <MotionReveal y={20} className="text-center mb-16">
          ...
          <p className="mx-auto max-w-xl text-lg text-muted">
            ...
            works across every major platform, with extra simultaneous-connection options available on every plan.
          </p>
        </MotionReveal>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 lg:gap-6">
          {DEVICES.map((device, i) => {
            ...
            return (
              <MotionReveal key={device.name} delay={i * 0.05} scale={0.8} y={0}>
                <div className="group flex flex-col items-center gap-4 rounded-2xl border border-violet-100/50 bg-white p-6 transition-all duration-300 hover:border-violet-200 hover:shadow-lg hover:shadow-violet-100/40 cursor-default">
