  ...
  return (
    <>
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <MotionReveal>
            <p className="mx-auto mt-12 max-w-3xl text-center text-base text-muted leading-relaxed">
              Comparing options before you buy? See{" "}
              <SectionLink href="#pricing" className={linkCls}>
                how the four plans compare
              </SectionLink>
              , read{" "}
              <SectionLink href="#subscription" className={linkCls}>
                what every subscription includes
              </SectionLink>{" "}
              or check{" "}
              <SectionLink href="#how-to-buy" className={linkCls}>
      ...
      {/* JSON-LD graph — Organization, WebSite, WebPage, Service, FAQPage.
          Organization and WebSite used to be defined on the homepage and only
          referenced by @id from here. "/" now 301s to this page, so that page
          never renders and both @ids resolved to nothing. This page is the site
          root, so it carries the definitions. */}
      <script
